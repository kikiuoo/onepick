...
def listView(request): # 오디션 Main
    ...
    return render(request, nUrl + '/profiles/list.html',
...
def viewer(request, cate_type, num) :
    ...
    return render(request,  nUrl + '/profiles/viewer.html', {'profiles':profiles, "userInfo":userInfo, "foreign" : foreign,
...
def viewer_all(request, cate_type, num):
    ...
    return render(request,  nUrl + '/profiles/viewer_all.html', {'profiles': profiles, "userInfo": userInfo, "foreign": foreign,
                                                    "careerEtc": careerEtc, "comment": comment, "pickCheck": pickCheck,
                                                    "profileImages": profileImages, "artImages": artImages,
...
def profileShare(request) :
    ...
    return render(request,  nUrl + '/profiles/viewer_share.html', {'profiles':profiles, "userInfo":userInfo, "foreign" : foreign,
                                                     "careerEtc":careerEtc, "comment":comment, "pickCheck" : pickCheck,
                                                     "profileImages" : profileImages, "artImages" : artImages,
                                                     "youtubes" : youtubes, "movieCareer" : movieCareer, "dramaCareer" : dramaCareer,
...
def pofile_write(request) :
    ...
    if user.name == "" or user.name == None or user.phone == "" or user.phone == None \
            or user.email == "" or user.email == None or user.birth == "" or user.birth == None  :
    ...
    return render(request, nUrl + '/profiles/write.html',
...
def pofile_edit(request, num) :
    ...
    return render(request, nUrl + '/profiles/edit.html', {'user':user, 'cate' : cate, 'num' : num, 'profiles' : profiles,
...
def audiAjaxGetCate(request) :
    ...
    return render(request,  nUrl + '/profiles/ajax_cate.html', {'catesub':catesub})
...
def audiAjaxGetCateEtc(request) :
    ...
    return render(request, nUrl + '/profiles/ajax_cate_etc.html', {'cate':cate})
...
def reloadComment(request) :
    ...
    return render(request,  nUrl + '/profiles/ajax_comment.html', {'comment': comment})
...
def printProfile(request, type, num) :
    ...
    return render(request,  nUrl + '/profiles/profile_'+type+'.html',
...
def getSubSpecialty(request) :
    ...
    return render(request,  nUrl + '/profiles/ajax_sub_specialty.html',
...
def getSubSpecialty2(request) :
    ...
    return render(request,  nUrl + '/profiles/ajax_sub_specialty2.html',
                  {'sub_specialty': sub_specialty, "specialty" : specialty})
